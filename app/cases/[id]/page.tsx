...
export default async function CasePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const view: CaseView = {
    ...
    openingPhraseKana: item.openingPhraseKana,
    openingPhraseRomaji: item.openingPhraseRomaji,
    openingPhraseIndonesian: item.openingPhraseIndonesian,
    questions: item.requiredQuestions.map((question) => ({
      id: question.id,
      topic: question.topic,
      acceptedPhrases: question.acceptedPhrases,
      acceptedPhraseReadings: question.acceptedPhraseReadings,
      why: question.why,
